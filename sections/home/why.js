        ...
        <div className=" h-full w-[73.5%] ">
          <div className=" h-[35%] flex">
            <div
              ...
              className=" bg-cover text-[#00000046]  flex text-center pt-[1.5rem] justify-center text-[1.3rem] font-medium w-[35%] "
            >
          ...
          <div className="h-[65%] flex">
            <div
              ...
              className=" bg-cover flex relative items-center justify-center text-[2rem] font-medium text-black w-[60%] h-full "
            ...
            <div
              ...
              className=" bg-cover text-[white] relative flex items-center justify-center text-[2rem] font-medium w-[40%] h-full"
